...
exports.up = function(knex) {
    ...
    return knex.schema.createTable('PLAN_CURR_NAC', function (table) {
        table.increments();
        /* table.string('ID').primary(); */
        table.string('COD_BNCC').notNullable();
        ...
        table.string('HABILIDADE_BNCC').notNullable();
        table.string('COMENTARIO_BNCC').notNullable();
...
exports.down = function(knex) {
    return knex.schema.dropTable('PLAN_CURR_NAC');  
};
